...
grant select, insert, update, delete on mosaproy_bibliotecas.biblioteca to mosaproy_recursos;
...
CREATE TABLE LIBRO(
    ...
    USING INDEX (     
        CREATE UNIQUE INDEX LIBRO_PK ON LIBRO(RECURSO_ID)
        TABLESPACE INDX_TBS)
) TABLESPACE RECURSOS_TBS
...
CREATE TABLE REVISTA(
    ...
    USING INDEX (     
        CREATE UNIQUE INDEX REVISTA_PK ON REVISTA(RECURSO_ID)
        TABLESPACE INDX_TBS)
) TABLESPACE RECURSOS_TBS;
